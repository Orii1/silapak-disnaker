                ...
                <table class="table table-bordered">
                    <tr>
                        <td colspan="2">
                            ...
                            <div class="text-center">
                                <tr>
                                    <td>
                                        <b>Nama Perusahaan</b>
                                        <p>{{$data->phk_perusahaan->nama_perusahaan}}</p>
                                    </td>
                                    <td>
                                        <b>Peruntukkan</b>
                                        <p>{{$data->peruntukan}}</p>
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Selesai. Diselesaikan pada tanggal {{ $data->phk_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}</label>
                                </div>
                            </div>
                            @elseif ($data->phk_status->id_status == '4')
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Dikembalikan. Dikembalikan pada tanggal {{ $data->phk_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}, Menunggu Pemohon Memperbaiki Persyaratan</label>
                                </div>
                            </div>
                        ...
                        <td>
                            ...
                            <p class="my-0">
                                ...
                                @elseif ($data->phk_status->id_status == '1')
...
<div class="modal fade" id="terima" tabindex="-1" aria-labelledby="terimaLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/permohonan-phk/terima/{{$data->id_phk}}" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="card">
    <div class="mt-4 mx-3">
        ...
        @if ($data->status == '0')
            <div class="mt-4">
                <div class="text-center">
                    <label for=""><b>Setelah dilakukan pemeriksaan, dengan ini permohonan dari {{$data->phk_perusahaan->nama_perusahaan}} :</b></label><br>
                    <div class="mt-2">
