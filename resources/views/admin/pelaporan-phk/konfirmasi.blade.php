                ...
                <table class="table table-bordered w-100" style="background-color: white;">
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Selesai. Diselesaikan pada tanggal {{$data->updated_at->isoFormat('D MMMM Y')}} <a class="btn btn-success btn-sm" href="/storage/{{$data->user_id}}/phk/sk/{{$data->sk}}" title="Surat Keputusan" target="_blank"><i class="bi bi-file-earmark-check-fill"></i></a></label>
                                </div>
                            </div>
...
<div class="mt-2 mb-2">
    <label for=""><b>Konfirmasi Permohonan {{$data->phk_perusahaan->nama_perusahaan}} :</b></label>
...
<div class="modal fade" id="konfirmasi" tabindex="-1" aria-labelledby="konfirmasiLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/konfirmasi/permohonan-phk/{{$data->id_phk}}" method="POST" enctype="multipart/form-data">
            @csrf
