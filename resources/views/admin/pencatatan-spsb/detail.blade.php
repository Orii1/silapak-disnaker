...
<div class="mt-5">
    ...
    <div class="mt-4">
        <div class="text-center">
            ...
            <div class="mt-2">
                <a href="/permohonan-spsb/terima/{{$data->id}}" class="btn btn-success"><i class="bi bi-check-circle-fill" style="height:100px;color: white;"></i> Terima</a>
                <a href="/permohonan-spsb/tolak/{{$data->id}}" class="btn btn-danger"><i class="bi bi-x-circle-fill" style="height:100px;color: white;"></i> Tolak</a>
            </div>
        </div>
    </div>
