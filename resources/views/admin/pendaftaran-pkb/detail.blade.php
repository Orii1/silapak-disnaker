                ...
                <table class="table table-bordered" style="background-color: white;">
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Selesai. Diselesaikan pada tanggal {{ $data->pkb_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}</label>
                                </div>
                            </div>
                            @elseif ($data->pkb_status->id_status == '4')
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Dikembalikan. Dikembalikan pada tanggal {{ $data->pkb_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}, Menunggu Pemohon Memperbaiki Persyaratan</label>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <b>Nama Mediator</b>
                                <p>
                                    {{$data->pkb_status->status_cek->pengecekan_pegawai->nama_pegawai}}
                                </p>
                            </div>
                        </td>
                        <td>
                            ...
                            <b>Draft Surat Keputusan</b>
                                <p>
                                    @if ($data->pkb_status->id_status == "4")
                                    -
                                    @else
                                        @if ($data->pkb_status->keterangan == "Permohonan Sedang dicek oleh Mediator")
                                        -
                                        @else
                                            <a href="/storage/{{$data->pkb_perusahaan->id}}/pkb/sk/{{$data->pkb_status->sk}}" class="btn btn-success" target="_blank">
        ...
        <div class="modal fade" id="terima" tabindex="-1" aria-labelledby="terimaLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="/permohonan-pkb/terima/{{$data->id_pkb}}" method="POST" enctype="multipart/form-data">
                    @csrf
