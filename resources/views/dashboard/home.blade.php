  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-एँw7i7Cf3zFjsokChf7enPGasWCSHs0NEzUcQHmO9lwIIa6m+zFKySznwWnLlEyA" crossorigin="anonymous"></script>
    ...
    <section id="cta" class="cta">
        <div class="container text-center">
            ...
            <h1 data-aos="fade-up" data-aos-delay="100">Sistem Informasi Layanan Ketenagakerjaan Hubungan Industrial
            </h1>
            <h2 data-aos="fade-up" data-aos-delay="200">Mencetak Dokumen Anda Secara Mandiri</h2>
            <h3 data-aos="fade-up" data-aos-delay="300">"Ayo Lengkapi Sarana HI Buhan Pian, Sakira Bausaha Nyaman,
                Bagawi Tanang"</h3>
            <button type="button" class="btn btn-light btn-sm" ><a class="text-dark" href="/login">Ajukan Permohonan</a></button>
        </div>
    </section>
    ...
    <section id="about" class="section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                <div class="col-lg-6">
                    <p>
                        SILAKHI (Sistem Informasi Layanan Ketenagakerjaan dan Hubungan Industrial) adalah layanan daring
                        <i>(Online)</i> yang dapat membantu anda dalam mengajukan izin perusahaan anda. Beberapa Layanan
                        Kami yaitu :
                    </p>
                    <ul>
                ...
                <div class="col-lg-6 pt-4 pt-lg-0">
                    <p>
                        Dengan menggunakan SILAKHI anda dapat mengetahui progress permohonan anda dengan jelas tanpa
                        harus datang ketempat, lengkapi Sarana HI buhan Pian, Sakira Beusaha Nyaman, Bagawi Tanang.
                    </p>
                </div>
            </div>
    ...
    <footer id="footer" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-contact">
                        ...
                        <p>
                            ...
                            <strong>Email:</strong> admin@diskopukmnaker.banjarbarukota.go.id,
                            hubunganindustrialbjb@gmail.com<br>
                        </p>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <div class="social-links mt-3">
                            <a href="https://diskopukmnaker.banjarbarukota.go.id/" target="_blank" class="twitter"><i
                                    class='bx bxs-color'></i></a>
                            <a href="https://www.instagram.com/diskopukmnaker.banjarbaru/" target="_blank"
        ...
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                &copy; Copyright MFA & MN<strong></strong>
            </div>
            <div class="credits">
