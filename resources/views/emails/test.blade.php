            ...
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE;">
                  Dinas Koperasi kota Banjarbaru
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Untuk Menuju Dashboard klik tombol dibawah ini:
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding: 0 0 16px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Terima Kasih telah mendaftar pada SILAKHI!
                        </td>
                      </tr>
                      <tr>
                      <tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Hormat Kami, <br><strong>Dinas Koperasi kota Banjarbaru</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
