                ...
                <table class="table table-bordered w-100" style="background-color: white;">
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Selesai. Diselesaikan pada tanggal {{ $data->lks_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}</label>
                                </div>
                            </div>
                            @elseif ($data->lks_status->id_status == '4')
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Dikembalikan. Dikembalikan pada tanggal {{ $data->lks_status->updated_at->locale('id')->isoFormat('D MMMM Y') }}, Menunggu Pemohon Memperbaiki Persyaratan</label>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <b>Nama Mediator</b>
                                <p>
                                    {{$data->lks_status->status_cek->pengecekan_pegawai->nama_pegawai}}
                                </p>
                            </div>
                        </td>
                        <td>
                            ...
                            <b>Surat Keputusan</b>
                                <p>
                                    @if ($data->lks_status->id_status == "2"OR"3" AND $data->lks_status->status_cek->hasil_pengecekan == "Dokumen Valid")
