...
@section('content')
<div class="pagetitle">
    <h1>Rekapitulasi Permohonan Pendaftaran Lembaga Kerja Sama Bipartit</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/kabid/dashboard">Home</a></li>
        <li class="breadcrumb-item active">Rekapitulasi Permohonan Pendaftaran Lembaga Kerja Sama Bipartit</li>
      </ol>
    </nav>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#generatePDF').on('click', function() {
            var month = $('#month').val();
            var year = $('#year').val();
            window.location.href = '{{ route('generate.pdf_lks') }}?month=' + month + '&year=' + year;
        });
    });
</script>
@endsection
