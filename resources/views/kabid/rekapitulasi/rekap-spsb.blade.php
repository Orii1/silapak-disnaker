...
@section('content')
<div class="pagetitle">
    <h1>Rekapitulasi Permohonan Pencatatan Serikat Buruh/Serikat Pekerja</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/kabid/dashboard">Home</a></li>
        <li class="breadcrumb-item active">Rekapitulasi Permohonan Pencatatan Serikat Buruh/Serikat Pekerja</li>
      </ol>
    </nav>
</div>
