...
<head>
  ...
  <title>Kabid - Sistem Informasi Layanan Ketenagakerjaan Hubungan Industrial</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="ms-2">
            <a href="/kabid/dashboard" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        <div class="mx-5">
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-block">Kabid</span>
              </a>
        </div>
      </ul>
    </nav>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/kabid/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/kabid/profile">
