...
<head>
  ...
  <title>Mediator HI - Sistem Informasi Layanan Ketenagakerjaan Hubungan Industrial</title>
...
<body>
      ...
      <ul class="d-flex align-items-center">
        <div class="mx-5">
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-block">Mediator HI</span>
              </a>
        </div>
      </ul>
    </nav>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/mediator/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/mediator/profile">
