                ...
                <table class="table table-bordered w-100" style="background-color: white;">
                    <tr>
                        <td colspan="2">
                            ...
                            <div class="text-center">
                                <tr>
                                    <td>
                                        <b>Nama Perusahaan</b>
                                        <p>{{$data->lks_perusahaan->nama_perusahaan}}</p>
                                    </td>
                                    <td>
                                        <b>Peruntukkan</b>
                                        <p>{{$data->peruntukan}}</p>
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <label for="">Permohonan Telah Selesai. Diselesaikan pada tanggal {{$data->updated_at->isoFormat('D MMMM Y')}} <a class="btn btn-success btn-sm" href="/storage/{{$data->user_id}}/lks/sk/{{$data->sk}}" title="Surat Keputusan" target="_blank"><i class="bi bi-file-earmark-check-fill"></i></a></label>
                                </div>
                            </div>
                        ...
                        <td>
                            <b>Status</b>
                                ...
                                @elseif ($data->lks_status->id_status == '1')
                                    <div class="text-start">
                        ...
                        <td>
                            ...
                            <div class="">
                                <div class="">
                                    <div class="">
                                        <b>Pemeriksaan</b><br>
                                        <label for="">Nama Mediator :  <b><i>{{$data->lks_status->status_cek->pengecekan_pegawai->nama_pegawai}} </b></i></label><br>
                                    </div>
                                </div>
                            </div>
...
<div class="mb-2 mx-2">
    <a class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#hasil_lks"><i class="bi bi-file-earmark-bar-graph-fill" style="height:100px;color: wlkste;"></i> Hasil Periksa</a>
</div>
@endif
