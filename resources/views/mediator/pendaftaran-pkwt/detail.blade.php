...
@if ($data->pkwt_status->status_cek->hasil_pengecekan == 'Belum di Periksa')
    ...
    <div class="mb-2">
        <a class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#hasil_pkwt"><i class="bi bi-file-earmark-bar-graph-fill" style="height:100px;color: white;"></i> Hasil Periksa</a>
    </div>
@else
    <div class="card">
        <div class="mx-3 my-2">
