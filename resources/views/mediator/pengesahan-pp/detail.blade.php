        ...
        <div class="row">
            <div class="col-sm-12">
                <table class="table table-bordered w-100" style="background-color: white;">
                    ...
                    <tr>
                        <td>
                            @if ($data->pp_status->status_cek->hasil_pengecekan == 'Belum di Periksa')
                            <div class="">
                                <div class="">
                                    <div class="">
                                        <b>Pemeriksaan</b><br>
                                        <label for="">Nama Mediator :  <b><i>{{$data->pp_status->status_cek->pengecekan_pegawai->nama_pegawai}} </b></i></label><br>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="">
                                <div class="">
                                    <b>Pemeriksaan</b><br>
                                    <label for="">Nama Mediator : <b><i>{{$data->pp_status->status_cek->pengecekan_pegawai->nama_pegawai}} </i></b></label><br>
                                    <label for="">Hasil Periksa : <b><i>{{$data->pp_status->status_cek->hasil_pengecekan}} </i></b></label><br>
                                    <label for="">Pesan : <b><i>{{$data->pp_status->status_cek->pesan}} </i></b></label><br>
                                </div>
                            </div>
                            @endif
                        </td>
                        <td>
                            ...
                            <div class="mb-2 mx-2">
                                <a class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#hasil_pp"><i class="bi bi-file-earmark-bar-graph-fill" style="height:100px;color: wppte;"></i> Hasil Periksa</a>
                            </div>
                            @endif
