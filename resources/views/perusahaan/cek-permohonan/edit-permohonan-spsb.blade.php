        ...
        <div class="card-body">
            <div class="p-4">
                <div class="table-responsivee">
                    <form id="file-upload-form" action="/edit-permohonan-spsb/{{$pencatatanspsb->id_spsb}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            ...
                                            <label style="color: red;"><i>(tipe file .pdf/.jpg/.jpeg/.png)</i></label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
