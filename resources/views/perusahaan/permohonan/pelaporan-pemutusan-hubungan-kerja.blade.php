                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <div class="card-title" style="padding-top: 20px; padding-bottom: 15px;">
                                Permohonan Pelaporan Pemutusan Hubungan Kerja, {{$user->user_perusahaan->nama_perusahaan}}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade pt-3" id="alur-perizinan">
                    <div class="text-center">
                        <img src="/storage/asset/{{$asset_phk->alur_perizinan}}" class="img-fluid" alt="">
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        <div class="mb-4">
                            <div class="card-title">
                                ...
                                <label class="mt-2" style="font-size: 17px;">{{$asset_phk->dasar_hukum}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        <div class="mb-4">
                            <div class="card-title">
                                ...
                                <label class="mt-2" style="font-size: 17px;">{{$asset_phk->durasi_pemrosesan}}</label>
                            </div>
                        </div>
                    </div>
                </div>
