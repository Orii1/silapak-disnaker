                    ...
                    <div class="row">
                        ...
                        <div class="col-11">
                            <div class="card-title" style="padding-top: 20px; padding-bottom: 15px;">
                                Permohonan Pendaftaran Perjanjian Kerja Bersama, {{$user->user_perusahaan->nama_perusahaan}}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active profile-overview" id="persyaratan">
                    <div class="mt-4 mb-5">
                        <form id="file-upload-form" action="/permohonan/pendaftaran-pkb" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="tab-pane fade pt-3" id="alur-perizinan">
                    <div class="text-center">
                        <img src="/storage/asset/{{$asset_pkb->alur_perizinan}}" class="img-fluid" alt="">
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        <div class="mb-4">
                            <div class="card-title">
                                ...
                                <label class="mt-2" style="font-size: 17px;">{{$asset_pkb->dasar_hukum}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        <div class="mb-4">
                            <div class="card-title">
                                ...
                                <label class="mt-2" style="font-size: 17px;">{{$asset_pkb->durasi_pemrosesan}}</label>
                            </div>
                        </div>
                    </div>
                </div>
